...
\begin{table}[h!]
	...
	\resizebox{\textwidth}{!}{
		\begin{tabular}{lcccc}
			\toprule
			& \multicolumn{2}{c}{Results by Patterson \cite{patterson2017unlocking}} & \multicolumn{2}{c}{My results} \\
